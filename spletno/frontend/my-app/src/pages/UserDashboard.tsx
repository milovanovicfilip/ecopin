...
const UserDashboard: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const input = (e.currentTarget.elements.namedItem('city') as HTMLInputElement).value;
                ...
                <div className='add-report-background'>
                    ...
                    >
                      <div className="top">
                        ...
                        <hr/>
                        <div className="mb-3">
                        <input type="text" className="form-control curvy-less" id="reportTitle" placeholder="Enter title of report" value={title} onChange={(e) => setTitle(e.target.value) } required/>
                        </div>

                        <div className="mb-3">
                        <textarea className="form-control curvy" id="reportDescription" rows={4} placeholder="Enter description of report" value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
                        </div>
                    ...
                    <button type="button" className="custom-button mt-3" onClick={handleAddReport}>Add</button>
                </div>        
              </div>
            </div>
          </div>
